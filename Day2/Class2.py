...
class human(object):
	...
	## what is calls when you print object
	def __str__(self):
		return 'Human: %d year-old %s.' % (self.age, self.sex)
	
	## if you want a function that can apply when called
	## on class name or object of class
	@classmethod
...
me = human(23, "F", "Erin")
print me.latin_name
print me.speak("asldkfjlasdkf")
print me
print human.class_introduce()
print me.class_introduce()
